    ...
    <section className="about main-section flex-column-mobile" id="about">
      ...
      <div className="info flex-column-mobile">
        ...
        >
          <div>
            <div>
              <img className="my-photo" src="assets/avatar.jpg" alt="" />
            </div>
          </div>
        </div>
        {/* IMAGE ENDS */}
            ...
            <ul>
              ...
              <li>
                <span>
                  <span className="animated-layer fade-in-up-animation fadeInUp wow">
                    <span>Email :</span>
                    <span>innerpeace41025@gmail.com</span>
                  </span>
                </span>
              </li>
              <li>
                <span>
                  <span className="animated-layer fade-in-up-animation fadeInUp wow">
                    <span>Skype :</span>
                    <span>live:.cid.5839a6274c9bca33</span>
                  </span>
                </span>
              </li>
            </ul>
